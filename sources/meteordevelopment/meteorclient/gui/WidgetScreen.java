...
public abstract class WidgetScreen extends Screen {
    ...
    public boolean mouseClicked(Click click, boolean doubled) {
        ...
        return root.mouseClicked(new Click(mouseX, mouseY, click.comp_4800()), doubled);
    }
    ...
    public boolean mouseReleased(Click click) {
        ...
        if (debug && click.button() == GLFW_MOUSE_BUTTON_RIGHT) DEBUG_RENDERER.mouseReleased(root, new Click(mouseX, mouseY, click.comp_4800()), 0);

        return root.mouseReleased(new Click(mouseX, mouseY, click.comp_4800()));
    }
    ...
    public boolean keyReleased(KeyInput input) {
        ...
        if ((input.comp_4797() == GLFW_MOD_CONTROL || input.comp_4797() == GLFW_MOD_SUPER) && input.comp_4795() == GLFW_KEY_9) {
            debug = !debug;
            return true;
        }

        if ((input.comp_4795() == GLFW_KEY_ENTER || input.comp_4795() == GLFW_KEY_KP_ENTER) && enterAction != null) {
            enterAction.run();
            return true;
        }
    ...
    public boolean keyPressed(KeyInput input) {
        ...
        if (input.comp_4795() == GLFW_KEY_TAB) {
        ...
        return (control && input.comp_4795() == GLFW_KEY_C && toClipboard())
            || (control && input.comp_4795() == GLFW_KEY_V && fromClipboard());
    }
