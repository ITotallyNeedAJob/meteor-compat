...
public class MeshRenderer {
    ...
    // COMPAT: vanilla snippet pipelines (position_color) have no MeshData uniform.
    private boolean writeMeshData = true;
    ...
    public MeshRenderer writeMeshData(boolean writeMeshData) {
        this.writeMeshData = writeMeshData;
        return this;
    }
    ...
    public void end() {
        ...
        if (indexCount > 0) {
...

            {
                ...
                GpuBufferSlice meshData = writeMeshData ? MeshUniforms.write(RenderUtils.projection, RenderSystem.getModelViewStack()) : null;
                ...
                if (writeMeshData) pass.setUniform("MeshData", meshData);
