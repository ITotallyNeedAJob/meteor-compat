...
public class EntityUtils {
    ...
    public static BlockPos getCityBlock(PlayerEntity player) {
        ...
        for (Direction direction : DirectionAccessor.meteor$getHorizontal()) {
            ...
            double testDistanceSquared = Utils.squaredDistance(mc.player.getX(), mc.player.getY(), mc.player.getZ(), testPos.getX(), testPos.getY(), testPos.getZ());
    ...
    public static Color getColorFromDistance(Entity entity) {
        ...
        // COMPAT Phase 0: inlined PlayerUtils.distanceToCamera (PlayerUtils not ported yet).
        Vec3d cameraPos = mc.gameRenderer.getCamera().getCameraPos();
        double distance = Utils.distance(cameraPos.x, cameraPos.y, cameraPos.z, entity.getX(), entity.getY() + entity.getEyeHeight(entity.getPose()), entity.getZ());
