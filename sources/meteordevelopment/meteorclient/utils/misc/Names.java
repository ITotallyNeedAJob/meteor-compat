...
public class Names {
    ...
    public static String get(RegistryEntry<Enchantment> enchantment) {
        // COMPAT: Enchantment.description() unmapped in yarn build.3 -> comp_2686 (record component 0).
        return enchantmentEntryNames.computeIfAbsent(enchantment, enchantment1 -> StringHelper.stripTextFormat(enchantment.comp_349().comp_2686().getString()));
    }
