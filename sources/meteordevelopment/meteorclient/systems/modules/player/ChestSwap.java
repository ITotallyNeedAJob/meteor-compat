...
public class ChestSwap extends Module {
    ...
    public void swap() {
        ...
        if (currentItem.contains(DataComponentTypes.GLIDER)) {
            equipChestplate();
        } else if (currentItem.contains(DataComponentTypes.EQUIPPABLE) && currentItem.get(DataComponentTypes.EQUIPPABLE).comp_3174().getEntitySlotId() == EquipmentSlot.CHEST.getEntitySlotId()) {
            equipElytra();
        } else {
