...
public class AutoTool extends Module {
    ...
    private void onTick(TickEvent.Post event) {
        // COMPAT: InfinityMiner guard removed (module not bundled - needs Baritone).
    ...
    // COMPAT: Xray.ORES inlined (Xray module not bundled - needs Iris).
    private static final java.util.Set<net.minecraft.block.Block> FORTUNABLE_ORES = java.util.Set.of(net.minecraft.block.Blocks.COAL_ORE, net.minecraft.block.Blocks.DEEPSLATE_COAL_ORE, net.minecraft.block.Blocks.IRON_ORE, net.minecraft.block.Blocks.DEEPSLATE_IRON_ORE, net.minecraft.block.Blocks.GOLD_ORE, net.minecraft.block.Blocks.DEEPSLATE_GOLD_ORE, net.minecraft.block.Blocks.LAPIS_ORE, net.minecraft.block.Blocks.DEEPSLATE_LAPIS_ORE, net.minecraft.block.Blocks.REDSTONE_ORE, net.minecraft.block.Blocks.DEEPSLATE_REDSTONE_ORE, net.minecraft.block.Blocks.DIAMOND_ORE, net.minecraft.block.Blocks.DEEPSLATE_DIAMOND_ORE, net.minecraft.block.Blocks.EMERALD_ORE, net.minecraft.block.Blocks.DEEPSLATE_EMERALD_ORE, net.minecraft.block.Blocks.COPPER_ORE, net.minecraft.block.Blocks.DEEPSLATE_COPPER_ORE, net.minecraft.block.Blocks.NETHER_GOLD_ORE, net.minecraft.block.Blocks.NETHER_QUARTZ_ORE, net.minecraft.block.Blocks.ANCIENT_DEBRIS);

    private static boolean isFortunable(Block block) {
        if (block == Blocks.ANCIENT_DEBRIS) return false;
        return FORTUNABLE_ORES.contains(block) || block instanceof CropBlock;
    }
