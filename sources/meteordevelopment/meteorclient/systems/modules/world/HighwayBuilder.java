                ...
                if (isX && isZ) {
                    ...
                    if (!isZ) {
                        ...
                        if (b.mc.player.getZ() < 0) {
                            boolean forward = b.input.playerInput.comp_3159();
                            b.input.forward(b.input.playerInput.comp_3160());
                    ...
                    if (!isX) {
                        ...
                        if (b.mc.player.getX() < 0) {
                            boolean right = b.input.playerInput.comp_3162();
                            b.input.right(b.input.playerInput.comp_3161());
                            b.input.left(right);
                        }
                    }
