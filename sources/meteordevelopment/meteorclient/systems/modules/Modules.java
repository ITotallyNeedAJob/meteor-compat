...
public class Modules extends System<Modules> {
    ...
    // COMPAT perf (Electron idea, no addon needed): Modules.get() is on every
    // hot path (per-frame NoRender/lightmap/HUD checks, per-glyph text). Cache
    // the instance instead of doing a Systems map lookup on every call.
    ...
    private void initRender() {
        ...
        add(new TunnelESP());
        add(new VoidESP());
        // COMPAT: WallHack removed (needs Iris/Sodium internals, not bundled).
        add(new WaypointsModule());
        // COMPAT: Xray removed (needs Iris/Sodium internals, not bundled).
        add(new Zoom());
    }
    ...
    private void initWorld() {
        ...
        add(new Timer());
        add(new VeinMiner());
        // COMPAT: Excavator/InfinityMiner removed (need Baritone, not bundled).
    }
    ...
    private void initMisc() {
        ...
        add(new BetterChat());
        add(new BookBot());
        // COMPAT: DiscordPresence removed (needs Discord IPC, not bundled).
