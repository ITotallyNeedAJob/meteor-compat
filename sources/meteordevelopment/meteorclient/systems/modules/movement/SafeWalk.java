            ...
            if (!isSprinting) {
                if (closeToEdge) {
                    mc.player.input.playerInput = new PlayerInput(
                        mc.player.input.playerInput.comp_3159(),
                        mc.player.input.playerInput.comp_3160(),
                        mc.player.input.playerInput.comp_3161(),
                        mc.player.input.playerInput.comp_3162(),
                        mc.player.input.playerInput.comp_3163(),
                        true,
                        mc.player.input.playerInput.comp_3165()
                    );
