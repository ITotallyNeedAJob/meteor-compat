...
public abstract class Account<T extends Account<?>> implements ISerializable<T> {
    ...
    public static void setSession(Session session) {
        ...
        mca.meteor$setGameProfileFuture(CompletableFuture.supplyAsync(() -> mc.getApiServices().comp_837().fetchProfile(mc.getSession().getUuidOrNull(), true), Util.getIoWorkerExecutor()));
    }
