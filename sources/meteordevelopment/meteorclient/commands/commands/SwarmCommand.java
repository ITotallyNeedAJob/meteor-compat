...
public class SwarmCommand extends Command {
        ...
        builder.then(literal("infinity-miner").executes(context -> {
            ...
            if (swarm.isActive()) {
                if (swarm.isHost()) {
                    ...
                    // COMPAT: runInfinityMiner removed (InfinityMiner not bundled - needs Baritone).
                }
            }
            else {
                throw SWARM_NOT_ACTIVE.create();
        ...
        .then(argument("target", BlockStateArgumentType.blockState(REGISTRY_ACCESS)).executes(context -> {
            ...
            if (swarm.isActive()) {
                if (swarm.isHost()) {
                    ...
                    // COMPAT: InfinityMiner targetBlocks removed (module not bundled).
                }
            }
            else {
                throw SWARM_NOT_ACTIVE.create();
        ...
        .then(argument("repair", BlockStateArgumentType.blockState(REGISTRY_ACCESS)).executes(context -> {
            ...
            if (swarm.isActive()) {
                if (swarm.isHost()) {
                    ...
                    // COMPAT: InfinityMiner target/repairBlocks removed (module not bundled).
                }
            }
            else {
                throw SWARM_NOT_ACTIVE.create();
        ...
        .then(literal("logout").then(argument("logout", BoolArgumentType.bool()).executes(context -> {
            ...
            if (swarm.isActive()) {
                if (swarm.isHost()) {
                    ...
                    // COMPAT: InfinityMiner logOut removed (module not bundled).
                }
            }
            else {
                throw SWARM_NOT_ACTIVE.create();
        ...
        .then(literal("walkhome").then(argument("walkhome", BoolArgumentType.bool()).executes(context -> {
            ...
            if (swarm.isActive()) {
                if (swarm.isHost()) {
                    ...
                    // COMPAT: InfinityMiner walkHome removed (module not bundled).
                }
            } else {
                throw SWARM_NOT_ACTIVE.create();
            }
    ...
    // COMPAT: runInfinityMiner removed (InfinityMiner module not bundled - needs Baritone).
